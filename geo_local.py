...
class GeoportalLokalizator:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'GeoportalLokalizator_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Geoportal Lokalizator')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('GeoportalLokalizator', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/geo_local/icon.png'
        self.add_action(
            icon_path,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginWebMenu(
                self.tr(u'&Geoportal Lokalizator'),
                action)
